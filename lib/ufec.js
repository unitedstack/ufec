...
import { Icon, Tabs, Spin, Button, Dropdown, Menu, Select, Table, Input, Alert, AutoComplete, Form, InputNumber, Tooltip, Radio, Slider, Switch, Checkbox, TreeSelect, DatePicker, Modal, Steps } from 'antd';
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            props.tableLoading || state.loading ? React.createElement(
              ...
              React.createElement(Spin, { indicator: React.createElement(Icon, { type: 'loading', style: { fontSize: 30 } }) })
          ...
          if (btn.dropdown) {
            var menu = React.createElement(
              ...
              btn.dropdown.map(function (drop, i) {
                return drop.type && drop.type === 'divider' ? React.createElement(Menu.Divider, { key: i }) : React.createElement(
                  Menu.Item,
            ...
            return React.createElement(
              ...
              React.createElement(
                Button,
                { type: btn.type },
                React.createElement(Icon, { type: btn.iconPrefix || 'more' }),
                btn.value,
                ' ',
                React.createElement(Icon, { type: btn.iconSuffix || 'caret-down-right' })
              )
            );
          }
          return React.createElement(
...
var Modal$1 = function (_React$Component) {
  inherits(Modal$$1, _React$Component);

  function Modal$$1(props) {
    classCallCheck(this, Modal$$1);

    var _this = possibleConstructorReturn(this, (Modal$$1.__proto__ || Object.getPrototypeOf(Modal$$1)).call(this, props));
  ...
  createClass(Modal$$1, [{
    ...
    value: function render() {
      ...
      var spinProps = {
        ...
        indicator: React.createElement(Icon, { type: 'loading', style: { fontSize: 30 } })
      };
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          banner ? React.createElement(
            ...
            React.createElement(Alert, banner)
          ) : null,
        ...
        case 'password':
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(Icon, { onClick: this.togglePasswordVisiable, type: 'eye' })
            )
          );
        default:
          break;
...
var RadioModal = function (_React$Component) {
  ...
  createClass(RadioModal, [{
    ...
    value: function render() {
      ...
      var TheRadio = props.button ? RadioButton : Radio;
      var decorator = props.decorator;
      ...
      return React.createElement(
        ...
        state.allData.map(function (d, index) {
          return React.createElement(
            ...
            React.createElement(Icon, { className: !inlen ? 'pointer' : '', type: 'close', onClick: !inlen ? _this2.onDeleteClick.bind(_this2, index) : null })
          );
        })
      );
    }
      ...
      return React.createElement(
        ...
        state.initData.map(function (d, index) {
          return React.createElement(
            ...
            React.createElement(Icon, { className: !len ? 'pointer' : '', type: 'close', onClick: !len ? _this3.onDeleteInitClick.bind(_this3, index) : null })
          );
        })
      );
    }
...
var CodemirrorModal = function (_React$Component) {
  ...
  function CodemirrorModal(props) {
    ...
    _this.state = {
      ...
      lineNumbers: _this.props.lineNumbers || true
    };
    return _this;
  }
  ...
  createClass(CodemirrorModal, [{
    ...
    value: function componentDidMount() {
      ...
      var state = this.state;
      var editor = CodeMirror(this.ref, {
        value: state.value,
        mode: state.lang,
        theme: state.theme,
      ...
      editor.on('change', function (codemirrorIns, codemirrorObj) {
        _this2.onChange(editor.getValue());
      });
    }
  }, {
    key: 'render',
  ...
  createClass(IconLabel, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        props.icon_type && React.createElement(Icon, { type: props.icon_type }),
        React.createElement(
          'span',
...
var MetaPair = function MetaPair(_ref) {
  ...
  return React.createElement(
    ...
    getFieldDecorator(keyName + '-key', { initialValue: valueForkey })(React.createElement(Input, {
    ...
    getFieldDecorator(keyName + '-value', { initialValue: valueForValue })(React.createElement(Input, {
    ...
    React.createElement(Button, { icon: 'close', type: 'primary', className: 'meta-data-cancel', onClick: function onClick(e) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(Button, { className: 'meta-add-btn', icon: 'plus', type: 'primary', size: 'small' }),
            React.createElement(
              'span',
              null,
...
var CheckboxGroup$2 = Checkbox.Group;
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(Alert, { type: state.tipType, content: state.tip, showIcon: true, width: 462 })
          ),
          React.createElement(
            'div',
          ...
          React.createElement(
            ...
            React.createElement(Alert, { __: __, message: state.message, type: 'error', showIcon: true })
          )
        ),
        props.children
      );
              ...
              return !module.title ? module.items.map(function (item) {
                return React.createElement(
                  ...
                  React.createElement(
                    Link,
                    { to: '/' + item },
                    React.createElement(Icon, { type: _this2.getIconByName(item) }),
                    React.createElement(
                      'span',
                      null,
                      __[item]
                ...
                { key: module.title, title: React.createElement(
                    'span',
                    null,
                    React.createElement(Icon, { type: _this2.getIconByName(module.title) }),
                    React.createElement(
                      'span',
                      null,
                      __[module.title]
                ...
                module.items.map(function (item) {
                  return React.createElement(
                    ...
                    React.createElement(
                      Link,
                      { to: '/' + item },
                      React.createElement(Icon, { type: 'circle' }),
                      React.createElement(
                        'span',
                        null,
                        __[item]
...
export { Modal$1 as Main, modal as ModalV2, modal$1 as ModalPlus, modal$2 as ModalDelete, pop as ModalAlert, SideMenu, _export as Subs, HISTORY as history, request as ajax, fetch, errorSpy };
