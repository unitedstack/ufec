      ...
      return React.createElement(
        ...
        state.allData.map(function (d, index) {
          return React.createElement(
            ...
            React.createElement(_Input, { type: 'input', value: d.user_name, onChange: _this2.onInputChange.bind(_this2, index) }),
  ...
  this.dealChainPop = function (cb) {
    ...
    if (refList && refList.length > 1) {
      refList[len - 2].current.setState({
        ...
        refList.pop();
        // 清理全局事件中的当前pop的事件
        event.removeAllListeners(['valuesChange_' + index]);
        setTimeout(function () {
...
var EventEmitter2$1 = require('eventemitter2');
var event$1 = new EventEmitter2$1({
  wildcard: true,
  delimiter: '::',
  newListener: false,
  maxListeners: 100,
...
export { Modal as main, modal as modalV2, modal$1 as modalPlus, modal$2 as modalDelete, pop as modalAlert, SideMenu as sideMenu, _export as subs, HISTORY as history };
