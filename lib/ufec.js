  ...
  function ModalBase(props) {
    ...
    config.fields.map(function (field) {
      if (field.decorator && field.decorator.rules) {
        var isRequired = field.decorator.rules.some(function (rule) {
          return rule.required;
        });
        !isRequired ? _this.isNotRequired.push(field.decorator.id) : null;
      }
    });
    _this.state = {
      config: config,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleSubmit = function (e) {
    ...
    props.form.validateFields(function (err, values) {
      if (!err) {
        var isNotRequired = props.form.getFieldsValue(_this4.isNotRequired);
        Object.keys(isNotRequired).forEach(function (key) {
