...
var CustomDoubleInput = function (_Component) {
  inherits(CustomDoubleInput, _Component);

  function CustomDoubleInput(props) {
    classCallCheck(this, CustomDoubleInput);

    var _this = possibleConstructorReturn(this, (CustomDoubleInput.__proto__ || Object.getPrototypeOf(CustomDoubleInput)).call(this, props));
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'div',
                { className: 'btn-wrapper', style: { display: props.config.btn && props.config.btn.hide ? 'none' : 'block' } },
                React.createElement(
                  _Button,
